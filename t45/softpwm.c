 ...
 * License: GPLv3
 * Time-stamp: <Wed Jun 22 23:42:00 EDT 2011> 

Trying softpwm method of app note AVR136
...
// softPWM defs
#define CH1_CLEAR (pinlevelB &= ~(1 << PB3))
#define CH2_CLEAR (pinlevelB &= ~(1 << PB2))
#define CH3_CLEAR (pinlevelB &= ~(1 << PB0))
#define IN1_CLEAR (pinlevelB &= ~(1 << PB1))
#define IN2_CLEAR (pinlevelB &= ~(1 << PB4))
