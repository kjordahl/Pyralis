 ...
 * License: GPLv3
 * Time-stamp: <Tue Jul 26 00:01:55 EDT 2011> 
...
#define SEED_ADDR 0x10		/* EEPROM address to store random seed */

// pins for ATtiny84
//timer0 PWM
#define IN3 (1 << PB2)		/* Pin  5, OC0A */
#define IN4 (1 << PA7)		/* Pin  6, OC0B */
//timer1 PWM (not currently used)
...
static unsigned char outpin[3] = {OUT1, OUT2, OUT3};
